...
export default function WhatYouGetSection() {
  ...
  const handleEnrollClick = async (tier: string) => {
    ...
    try {
      ...
      await trackEvent({
        ...
        eventType: (`tier_select_${tier}` as const),
        eventData: { tier },
      });
    } catch (error) {
  ...
  return (
    <section className="py-8 md:py-0 lg:py-0 px-4 md:px-6 bg-white">
      ...
      <p className="text-xl text-slate-800 max-w-2xl mx-auto mb-8">
          You&apos;ve probably been told this is just &quot;getting older.&quot; That &quot;life&apos;s downhill after 30.&quot;<br/><br/>
          But if anything.. life as a man should get BETTER.<br/><br/>
          You shouldn&apos;t have to drag yourself out of bed wondering if you&apos;ll even get through the day. You shouldn&apos;t need coffee after coffee just to think straight, or drinks every night to shut your brain off.<br/><br/>
          Because without energy, you have <strong>NOTHING</strong>.
        </p>
        <div className="mt-12 text-center pt-2 mb-0">
          <p className="text-3xl font-medium mx-auto text-slate-800">
        ...
        <div className="hidden md:grid grid-cols-1 md:grid-cols-3 px-4 md:px-16 mx-0 md:mx-12 gap-0">
          ...
          <div className="bg-white border-2 border-t-gray-300 overflow-hidden flex flex-col relative">
            ...
            <div className="flex-grow flex flex-col">
              ...
              <h4 className="text-xl md:text-2xl mt-0 pt-6 md:pt-6 text-center font-['Open Sans'] font-extrabold -mx-4 -mb-3 bg-slate-300/10 text-black pb-4 md:pb-6">THE LIMITLESS PROTOCOL</h4>
                ...
                <div className="text-lg text-black mb-5 font-['Open Sans'] text-center font-normal">The complete system with video training, nutrition guides and full app access. Everything laid out step by step so you can follow it at your own pace with email support when you need it.</div>
              </div>
          ...
          <div className="bg-white -mt-6 border-2 md:border-0 lg:border-0 border-[#940909] rounded-sm overflow-hidden flex flex-col relative] transition-all">
            ...
            <h4 className="text-xl md:text-2xl mt-0 pt-6 md:pt-6 text-center font-['Open Sans'] font-extrabold -mx-4 -mb-3 bg-slate-300/10 text-[#940909] pb-4 md:pb-6">LIMITLESS LIFE</h4>
                ...
                <p className="text-lg text-black mb-5 font-['Open Sans'] text-center font-normal">Everything in Protocol plus weekly 1-on-1 coaching calls where you get personalized nutrition protocols, custom workout plans and priority support. This isn&apos;t self-paced, I work with you directly through the whole process.</p>
              </div>
              <div className="space-y-0">
                <div className="w-full flex gap-3  py-4 border-y border-gray-200">
          ...
          <div className="bg-white border-2 border-[#940909] mb-24 overflow-hidden flex flex-col relative] transition-all">
            ...
            <h4 className="text-xl md:text-2xl mt-0 pt-6 md:pt-6 text-center font-['Open Sans'] font-extrabold -mx-4 -mb-3 bg-slate-300/10 text-[#940909] pb-4 md:pb-6">LIMITLESS LIFE + PRIVATE</h4>
                ...
                <div className="w-full space-x-4 ml-10"></div>
                <div className="text-lg md:text-lg lg:text-lg italic text-black-600 mb-5 font-['Open Sans'] text-center font-bold">LIFESTYLE BODY DESIGN</div>
                <p className="text-lg text-black mb-5 font-['Open Sans'] text-center font-normal">Everything in Limitless Life plus private WhatsApp access with same-day responses, form check videos and real-time protocol adjustments. You get direct access to me whenever you need it.</p>
              </div>
              <div className="space-y-0">
              <div className="space-y-0">
          ...
          <div className="bg-white border-2 border-t-gray-300 overflow-hidden flex flex-col relative">
            ...
            <div className="flex-grow flex flex-col">
              ...
              <div className="space-y-0 mx-4">
                <div className="w-full flex gap-2 md:gap-3 py-2 md:py-4 border-y border-gray-200">
                  <div className="ml-0 md:ml-10">
                  <span className="gray-700 flex-shrink-0 text-sm md:text-base">✓</span>
                  <span className="text-gray-700 flex-shrink-0 text-sm md:text-base">Complete 4-Step System Protocol</span>
                  </div>
                </div>
                <div className="w-full flex gap-2 md:gap-3 py-2 md:py-4 border-b border-gray-200">
                  <div className="ml-0 md:ml-10">
                  <span className="gray-700 flex-shrink-0 text-sm md:text-base">✓</span>
                  <span className="text-gray-700 flex-shrink-0 text-sm md:text-base">Video Training Library</span>
                  </div>
                </div>
                <div className="w-full flex gap-2 md:gap-3 py-2 md:py-4 border-b border-gray-200">
                  <div className="ml-0 md:ml-10">
                  <span className="gray-700 flex-shrink-0 text-sm md:text-base">✓</span>
                  <span className="text-gray-700 flex-shrink-0 text-sm md:text-base">Nutrition & Supplement Guides</span>
                  </div>
                </div>
                <div className="w-full flex gap-2 md:gap-3 py-2 md:py-4 border-b border-gray-200">
                  <div className="ml-0 md:ml-10">
                  <span className="gray-700 flex-shrink-0 text-sm md:text-base">✓</span>
                  <span className="text-gray-700 flex-shrink-0 text-sm md:text-base">Mobile App Access</span>
                  </div>
                </div>
                <div className="w-full flex gap-2 md:gap-3 py-2 md:py-4 border-b border-gray-200">
                  <div className="ml-0 md:ml-10">
                  <span className="gray-700 flex-shrink-0 text-sm md:text-base">✓</span>
                  <span className="text-gray-700 flex-shrink-0 text-sm md:text-base">Email Support</span>
                  </div>
                </div>
              </div>
