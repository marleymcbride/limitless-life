  ...
  const falseBeliefs: FalseBelief[] = [
    {
      ...
      proof:
        "94% of our clients train 3 days or less and average 26 lbs weight loss",
    },
    {
      belief: "I can't quit coffee - I need it for business performance",
      reality:
        "Natural energy gives you superior mental clarity without crashes",
      proof:
        "89% of former coffee drinkers report better focus and decision-making",
    },
    {
      belief: "I need alcohol to network and de-stress after work",
      reality: "Alcohol destroys sleep quality and next-day performance",
      proof:
        "Alcohol-free clients report 47% better sleep and 32% higher productivity",
    },
    {
      ...
      proof:
        "CEOs who optimize health outperform peers by 23% in revenue growth",
    },
    {
      belief: "I've tried everything - nothing works for people like me",
      reality:
        "You haven't tried a system built for high-performers' specific needs",
      proof:
        "Former skeptics are now our biggest advocates - see testimonials above",
    },
  ];
  ...
  return (
    <section className={`${colorStrategy.whiteSections} py-20`}>
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-5xl mx-auto space-y-8">
          {falseBeliefs.map((item, index) => (
            ...
            >
              {/* The Lie */}
              <div
                className={`${colorStrategy.blackSections} p-6 border-b border-gray-200`}
              >
                <div className="flex items-start">
                  <div className="flex-shrink-0 mr-4">
                    <div
                      className={`w-8 h-8 ${colorStrategy.redCTA} rounded-full flex items-center justify-center`}
                    >
                  ...
                  <div>
                    <h3
                      className={`text-xl font-black text-white font-serif mb-2`}
                    >
                      THE LIE:
                    </h3>
              ...
              <div className="p-6 bg-white">
                <div className="flex items-start">
                  ...
                  <div className="flex-1">
                    ...
                    <p
                      className={`text-lg ${colorStrategy.blackSections} font-serif mb-4`}
                    >
                      {item.reality}
                    </p>
        ...
        <div
          className={`mt-16 ${colorStrategy.blackSections} rounded-lg p-8 text-center`}
        >
          <h3
          ...
          <p
            className={`text-lg text-white max-w-3xl mx-auto font-serif leading-relaxed mb-6`}
          >
            Most fitness advice is made for 20-year-olds who have 4 hours a day
            to spend in the gym. You're running a company, managing a team, and
            trying to be present with your family.
          </p>
