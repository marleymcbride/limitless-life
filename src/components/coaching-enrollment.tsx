    ...
    <section className="py-8 md:py-16 px-4 md:px-6 bg-white">
      <div className="container mx-auto max-w-6xl">
        <div className="text-center mb-6 md:mb-12">
          ...
          <p className="text-base px-6  md:text-lg text-gray-700">
            Complete access to our proven 4-step system designed specifically for high-performers.
          </p>
        </div>

        <div className="grid mr-4 px-4 grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6 lg:gap-8">
          {items.map((item, index) => (
            <div
              key={index}
              className="bg-gray-50 px-4 md:px-6 lg:px-8 rounded-lg p-4 py-6 md:p-6 lg:p-8 border border-gray-200"
            >
              <h3
                className="text-lg md:text-xl font-bold text-center md:text-left lg:text-left text-gray-900 mb-6 md:mb-4"
                style={{ fontFamily: "Neuemontreal, sans-serif" }}
              >
                {item.title}
              </h3>
              <p className="text-gray-700 text-sm text-center md:text-left lg:text-left md:text-base leading-relaxed">
                {item.description}
              </p>
            </div>
          ))}
      ...
      <div className="mt-0 pt-0">
        ...
        <p className="text-sm text-gray-800 max-w-2xl px-6 mb-0">
        ...
        <div className="text-2xl text-center text-gray-800 mb-12 leading-tight px-6 text-normal">
            <strong>HERES YOUR OPTIONS:</strong>
          </div>
        ...
        <div className="hidden md:grid grid-cols-1 md:grid-cols-3 px-4 md:px-16 mx-0 md:mx-12 gap-0">
          ...
          <div className="bg-white border-2 border-t-gray-300 overflow-hidden flex flex-col relative">
            ...
            <div className="flex-grow flex flex-col">
              ...
              <h4 className="text-xl md:text-2xl mt-0 pt-6 md:pt-6 text-center font-['Bebas Neue'] font-medium -mx-4 -mb-3 bg-slate-300/10 text-black pb-4 md:pb-6">THE LIMITLESS PROTOCOL</h4>
              ...
              <div className="space-y-0">
                <div className="w-full flex gap-3 py-4 border-y border-gray-200">
                  <div className="ml-10 flex items-start gap-3">
                    <span className="text-gray-700 flex-shrink-0 w-5">✓</span>
                    <span className="text-gray-700 text-lg flex-1">Complete 4-Step System Protocol</span>
                  </div>
                </div>
                <div className="w-full flex gap-3 py-4 border-b border-gray-200">
                  <div className="ml-10 flex items-start gap-3">
                    <span className="text-gray-700 flex-shrink-0 w-5">✓</span>
                    <span className="text-gray-700 text-lg flex-1">Video Training Library</span>
                  </div>
                </div>
                <div className="w-full flex gap-3 py-4 border-b border-gray-200">
                  <div className="ml-10 flex items-start gap-3">
                    <span className="text-gray-700 flex-shrink-0 w-5">✓</span>
                    <span className="text-gray-700 text-lg flex-1">Nutrition & Supplement Guides</span>
                  </div>
                </div>
                <div className="w-full flex gap-3 py-4 border-b border-gray-200">
                  <div className="ml-10 flex items-start gap-3">
                    <span className="text-gray-700 flex-shrink-0 w-5">✓</span>
                    <span className="text-gray-700 text-lg flex-1">Mobile App Access</span>
                  </div>
                </div>
                <div className="w-full flex gap-3 py-4 border-gray-200">
                  <div className="ml-10 flex items-start gap-3">
                    <span className="text-gray-700 flex-shrink-0 w-5">✓</span>
                    <span className="text-gray-700 text-lg flex-1">Email Support</span>
                  </div>
                </div>
              </div>
              <div className="pt-6">
          ...
          <div className="bg-white -mt-6 border-2 md:border-0 lg:border-0 border-[#940909] rounded-sm overflow-hidden flex flex-col relative] transition-all">
            ...
            <h4 className="text-xl md:text-2xl mt-0 pt-6 md:pt-6 text-center font-['Bebas Neue'] font-medium -mx-4 -mb-3 bg-slate-300/10 text-black pb-4 md:pb-6">LIMITLESS LIFE</h4>
              ...
              <div className="space-y-0">
                <div className="w-full flex gap-3 py-4 border-y border-gray-200">
                  <div className="ml-8 flex items-start gap-3">
                    <span className="text-green-600 flex-shrink-0 w-5">✓</span>
                    <span className="text-gray-700 text-lg font-bold flex-1">Everything in Protocol, plus:</span>
                  </div>
                </div>
                <div className="w-full flex gap-3 py-4 border-b border-gray-200">
                  <div className="ml-8 flex items-start gap-3">
                    <span className="text-green-600 flex-shrink-0 w-5">✓</span>
                    <span className="text-gray-700 text-lg flex-1">Weekly 1-on-1 coaching calls (4 total)</span>
                  </div>
                </div>
                <div className="w-full flex gap-3 py-4 border-b border-gray-200">
                  <div className="ml-8 flex items-start gap-3">
                    <span className="text-green-600 flex-shrink-0 w-5">✓</span>
                    <span className="text-gray-700 text-lg flex-1">Personalized nutrition protocol</span>
                  </div>
                </div>
                <div className="w-full flex gap-3 py-4 border-b border-gray-200">
                  <div className="ml-8 flex items-start gap-3">
                    <span className="text-green-600 flex-shrink-0 w-5">✓</span>
                    <span className="text-gray-700 text-lg flex-1">Workout plan customization</span>
                  </div>
                </div>
                <div className="w-full flex gap-3 py-4 border-b border-gray-200">
                  <div className="ml-8 flex items-start gap-3">
                    <span className="text-green-600 flex-shrink-0 w-5">✓</span>
                    <span className="text-gray-700 text-lg flex-1">Priority email support for customers in work hours</span>
                  </div>
                </div>
                <div className="w-full flex gap-3 py-4">
                  <div className="ml-8 flex items-start gap-3">
                    <span className="text-green-600 flex-shrink-0 w-5">✓</span>
                    <span className="text-gray-700 text-lg flex-1">Priority email support</span>
                  </div>
                </div>
              </div>
              <div className="pt-6">
          ...
          <div className="bg-white border-2 border-[#940909] mb-24 overflow-hidden flex flex-col relative] transition-all">
            ...
            <h4 className="text-xl md:text-2xl mt-0 pt-6 md:pt-6 text-center font-['Bebas Neue'] font-medium -mx-4 -mb-3 bg-slate-300/10 text-black pb-4 md:pb-6">LIMITLESS LIFE + PRIVATE</h4>
              ...
              <div className="space-y-0">
                <div className="w-full flex gap-3 py-4 border-y border-gray-200">
                  <div className="ml-10 flex items-start gap-3">
                    <span className="text-green-600 flex-shrink-0 w-5">✓</span>
                    <span className="text-gray-700 text-lg font-bold flex-1">Everything in Limitless Life, plus:</span>
                  </div>
                </div>
                <div className="w-full flex gap-3 py-4 border-b border-gray-200">
                  <div className="ml-10 flex items-start gap-3">
                    <span className="text-green-600 flex-shrink-0 w-5">✓</span>
                    <span className="text-gray-700 text-lg flex-1">Access to my private Whatsapp</span>
                  </div>
                </div>
                <div className="w-full flex gap-3 py-4 border-b border-gray-200">
                  <div className="ml-10 flex items-start gap-3">
                    <span className="text-green-600 flex-shrink-0 w-5">✓</span>
                    <span className="text-gray-700 text-lg flex-1">Same-day response guarantee</span>
                  </div>
                </div>
                <div className="w-full flex gap-3 py-4 border-b border-gray-200">
                  <div className="ml-10 flex items-start gap-3">
                    <span className="text-green-600 flex-shrink-0 w-5">✓</span>
                    <span className="text-gray-700 text-lg flex-1">Form check via video</span>
                  </div>
                </div>
                <div className="w-full flex gap-3 py-4">
                  <div className="ml-10 flex items-start gap-3">
                    <span className="text-green-600 flex-shrink-0 w-5">✓</span>
                    <span className="text-gray-700 text-lg flex-1">Real-time protocol adjustments</span>
                  </div>
                </div>
              </div>
              <div className="pt-6">
        ...
        <div className="block md:hidden lg:hidden grid-cols-1 md:grid-cols-3 px-4 md:px-16 mx-0 md:mx-12 gap-2 space-y-2 md:gap-6 lg:gap-8">
          ...
          <div className="bg-white border-2 border-t-gray-300 overflow-hidden flex flex-col relative">
            ...
            <div className="flex-grow flex flex-col">
              ...
              <p className="text-5xl font-bold text-white mb-4"></p>
                <div className="w-full space-x-4 ml-10"></div>
                <div className="text-lg md:text-lg lg:text-lg italic text-black-600 mt-6 mb-5 font-['Open Sans'] text-center font-normal">LIFESTYLE BODY DESIGN</div>
                <div className="text-lg text-black mb-5 font-['Open Sans'] text-center font-medium">Get the Bachelors Degree curriculum to learn how to build an authentic brand while posting about your interests.</div>
              </div>

              <div className="space-y-0 mx-4">
                <div className="w-full flex gap-2 md:gap-3 py-2 md:py-3 md:py-4 border-y border-gray-200">
                  <div className="ml-0 md:ml-10 flex items-start gap-2 md:gap-3">
                    <span className="text-gray-700 flex-shrink-0 w-5 text-sm md:text-base">✓</span>
                    <span className="text-gray-700 flex-1 text-sm md:text-base md:text-lg">Complete 4-Step System Protocol</span>
                  </div>
                </div>
                <div className="w-full flex gap-2 md:gap-3 py-2 md:py-3 md:py-4 border-b border-gray-200">
                  <div className="ml-0 md:ml-10 flex items-start gap-2 md:gap-3">
                    <span className="text-gray-700 flex-shrink-0 w-5 text-sm md:text-base">✓</span>
                    <span className="text-gray-700 flex-1 text-sm md:text-base md:text-lg">Video Training Library</span>
                  </div>
                </div>
                <div className="w-full flex gap-2 md:gap-3 py-2 md:py-3 md:py-4 border-b border-gray-200">
                  <div className="ml-0 md:ml-10 flex items-start gap-2 md:gap-3">
                    <span className="text-gray-700 flex-shrink-0 w-5 text-sm md:text-base">✓</span>
                    <span className="text-gray-700 flex-1 text-sm md:text-base md:text-lg">Nutrition & Supplement Guides</span>
                  </div>
                </div>
                <div className="w-full flex gap-2 md:gap-3 py-2 md:py-3 md:py-4 border-b border-gray-200">
                  <div className="ml-0 md:ml-10 flex items-start gap-2 md:gap-3">
                    <span className="text-gray-700 flex-shrink-0 w-5 text-sm md:text-base">✓</span>
                    <span className="text-gray-700 flex-1 text-sm md:text-base md:text-lg">Mobile App Access</span>
                  </div>
                </div>
                <div className="w-full flex gap-2 md:gap-3 py-2 md:py-3 md:py-4 border-b border-gray-200">
                  <div className="ml-0 md:ml-10 flex items-start gap-2 md:gap-3">
                    <span className="text-gray-700 flex-shrink-0 w-5 text-sm md:text-base">✓</span>
                    <span className="text-gray-700 flex-1 text-sm md:text-base md:text-lg">Email Support</span>
                  </div>
                </div>
              </div>
              <div className="pt-6">
          ...
          <div className="bg-white md:-mt-6 lg:-mt-6 border-2 md:border-0 lg:border-0 border-[#940909] rounded-sm overflow-hidden flex flex-col relative] transition-all">
            ...
            <p className="text-5xl font-bold text-white mb-4"></p>
              ...
              <div className="space-y-0 -ml-4 mr-8">
                <div className="w-full flex gap-3 py-4 border-y border-gray-200">
                  <div className="ml-10 flex items-start gap-3">
                    <span className="text-green-600 flex-shrink-0 w-5">✓</span>
                    <span className="text-gray-700 text-lg font-bold flex-1">Everything in Protocol, plus:</span>
          ...
          <div className="bg-white border-2 border-[#940909] mb-24 overflow-hidden flex flex-col relative] transition-all">
            ...
            <div className="flex-grow bg-blue flex flex-col">
            <div className="pt-0 bg-blue px-4 pb-0">
            <h4 className="text-xl md:text-2xl mt-0 pt-6 md:pt-6 text-center font-['Bebas Neue'] font-black -mx-4 -mb-3 bg-slate-300/10 text-[#940909] pb-4 md:pb-6">LIMITLESS LIFE + PRIVATE</h4>
                <p className="text-5xl font-bold text-white mb-4"></p>
                <div className="w-full space-x-4 ml-10"></div>
                <div className="text-lg md:text-lg lg:text-lg italic text-black-600 mt-6 mb-5 font-['Open Sans'] text-center font-normal">LIFESTYLE BODY DESIGN</div>
                <div className="text-lg text-black mb-5 font-['Open Sans'] text-center font-medium">Get the Bachelors Degree curriculum to learn how to build an authentic brand while posting about your interests.</div>
