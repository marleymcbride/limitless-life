      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl max-w-3xl mx-auto text-white/90">
            I was exactly where you are now — burned out, dependent, and trapped
            in the 4% category
          </p>
        </div>
        ...
        <div className="max-w-4xl mx-auto mb-16">
          <div className="bg-black/40 backdrop-blur-sm p-8 rounded-lg border border-[#940909]/30 mb-8">
            ...
            <div className="space-y-4 text-white/90">
              <p>
                I was that guy who "had it all together" on paper. Successful
                business, good income, hitting the gym regularly. But
                underneath? I was falling apart.
              </p>
              <p>
                Every morning started with caffeine. Every evening ended with
                alcohol. I was carrying an extra 25 pounds of stress weight, my
                energy crashed every afternoon, and I couldn't sleep without a
                few drinks to "wind down."
              </p>
              <p className="font-bold text-[#ff6b6b]">
                Sound familiar? I was trapped in the 4% category —
                health-conscious but health-broken.
              </p>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-12">
            ...
            <div className="bg-black/40 backdrop-blur-sm p-6 rounded-lg border border-green-500/30">
              ...
              <ul className="space-y-2 text-white/90">
                <li>
                  • <strong>1,000+ days</strong> completely alcohol-free
                </li>
                <li>
                  • <strong>1+ year</strong> completely caffeine-free
                </li>
        ...
        <div className="max-w-4xl mx-auto mb-16">
          <div className="bg-white/10 backdrop-blur-sm p-8 rounded-lg border border-[#940909]/50">
            ...
            <div className="space-y-4 text-white/90">
              <p className="text-lg">
                After years of struggling, I discovered something the fitness
                industry doesn't want you to know:
              </p>
              <div className="bg-[#940909]/30 p-6 rounded-lg border border-[#940909]/50">
                <p className="text-xl font-bold text-white mb-4">
                  "80% of your energy problems come from just 20% of your
                  habits"
                </p>
                <p className="text-white/90">
                  It's not about training harder, eating less, or taking more
                  supplements. It's about finding your personal
                  <span className="font-bold text-[#ff6b6b]">
                    {" "}
                    Natty Sweet Spot
                  </span>{" "}
                  — where your body naturally optimizes energy, hormones, and
                  performance without artificial crutches.
                </p>
              </div>
              <p className="text-lg">
                This discovery led me to develop what I call{" "}
                <strong>Drag Energy vs Glide Energy</strong> — the difference
                between fighting your biochemistry every day and working with it
                to feel naturally incredible.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="text-center mb-16">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-4xl mx-auto">
            <div className="bg-black/40 backdrop-blur-sm p-6 rounded-lg border border-[#940909]/30">
              <div className="text-3xl font-bold text-[#940909] mb-2">
                1000+
              </div>
        ...
        <div className="max-w-4xl mx-auto text-center">
          <div className="bg-white/10 backdrop-blur-sm p-8 rounded-lg border border-[#940909]/50">
            <h3 className="text-2xl font-bold text-white mb-6">
              From Drag Energy to Glide Energy
            </h3>
            <div className="grid md:grid-cols-2 gap-8 text-left">
              <div>
                <h4 className="font-bold text-red-300 mb-3">
                  DRAG ENERGY (Where You Are)
                </h4>
              ...
              <div>
                <h4 className="font-bold text-green-300 mb-3">
                  GLIDE ENERGY (Where You're Going)
                </h4>
                <ul className="space-y-2 text-white/90 text-sm">
            ...
            <p className="text-xl font-bold text-white mt-6">
              This transformation is what I help high-performing men achieve
              through The Limitless Protocol.
            </p>
          </div>
        </div>
      </div>
