...
export default function BenefitsSection() {
  return (
    <section className="w-full bg-grey py-20 px-4 text-white">
      <div className="container mx-auto px-4">
        <h2 className="mb-4 text-center text-2xl font-bold md:text-3xl">
          The Limitless Protocol Components
        </h2>
        <p className="text-center text-lg mb-12 mx-auto max-w-3xl">
          Our systems-based approach creates natural energy - lean physique -
          mental clarity without relying on willpower or extreme measures
        </p>
        ...
        <div className="mx-auto grid gap-8 md:grid-cols-2">
          <div className="rounded-lg bg-zinc-800 p-6 border-l-4 border-[#940909] shadow-lg">
            <div className="flex items-center mb-6">
              ...
              <h3 className="text-xl font-bold">Morning Fuel System</h3>
            </div>
            <p className="mb-4 text-gray-300">
              Exact, systemized routine of specific foods and actions in set
              order. Delivers clear thinking and smooth energy without caffeine
              or supplements.
            </p>
          ...
          <div className="rounded-lg bg-zinc-800 p-6 border-l-4 border-[#940909] shadow-lg">
            <div className="flex items-center mb-6">
              ...
              <h3 className="text-xl font-bold">Minimalist Training</h3>
            </div>
            <p className="mb-4 text-gray-300">
          ...
          <div className="rounded-lg bg-zinc-800 p-6 border-l-4 border-[#940909] shadow-lg">
            ...
            <p className="mb-4 text-gray-300">
              How all three systems work together to create effortless
              transformation. The complete roadmap from where you are now to
              total Limitless energy and physique.
            </p>
            <ul className="space-y-3 mt-6">
              <li className="flex items-start">
                <Check className="mr-2 mt-1 h-4 w-4 text-[#940909] flex-shrink-0" />
              ...
              <li className="flex items-start">
                <Check className="mr-2 mt-1 h-4 w-4 text-[#940909] flex-shrink-0" />
                <span className="text-sm">
                  High-performance habit installation process
                </span>
              </li>
              <li className="flex items-start">
                <Check className="mr-2 mt-1 h-4 w-4 text-[#940909] flex-shrink-0" />
                <span className="text-sm">
                  Real-world application for busy professionals
                </span>
              </li>
              <li className="flex items-start">
                <Check className="mr-2 mt-1 h-4 w-4 text-[#940909] flex-shrink-0" />
                <span className="text-sm">
                  Built-in troubleshooting and personalization
                </span>
              </li>
            </ul>
          </div>
