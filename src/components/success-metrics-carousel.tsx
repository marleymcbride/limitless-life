...
const successMetrics = [
  {
    ...
    testimonial:
      "The program completely changed my relationship with food and exercise. I've got more energy than I've had in 15 years.",
  },
  {
    name: "David L.",
    age: 46,
    ...
    imageSrc: "/placeholder.svg?height=400&width=300",
    testimonial:
      "As a busy CEO, I didn't think I had time for my health. This program proved me wrong. It's efficient, effective, and life-changing.",
  },
  {
    name: "Robert J.",
    age: 41,
    ...
    imageSrc: "/placeholder.svg?height=400&width=300",
    testimonial:
      "I've tried countless diets and programs before. This is the only one that actually delivered sustainable results that fit my executive lifestyle.",
  },
];
...
export default function SuccessMetricsCarousel() {
  ...
  const nextSlide = () => {
    ...
    setIsAnimating(true);
    setActiveIndex((prev) =>
      prev === successMetrics.length - 1 ? 0 : prev + 1
    );
  ...
  const prevSlide = () => {
    ...
    setIsAnimating(true);
    setActiveIndex((prev) =>
      prev === 0 ? successMetrics.length - 1 : prev - 1
    );
    setTimeout(() => setIsAnimating(false), 500); // Match the transition duration
  };
  ...
  const weightLoss =
    activeClient.initialMetrics.weight - activeClient.finalMetrics.weight;
  const bodyFatReduction =
    activeClient.initialMetrics.bodyFat - activeClient.finalMetrics.bodyFat;
  const energyGain =
    activeClient.finalMetrics.energy - activeClient.initialMetrics.energy;
    ...
    <section className="w-full py-16 bg-zinc-900 text-white">
      <div className="container mx-auto px-4">
        ...
        <p className="text-xl text-center max-w-3xl mx-auto mb-12">
          See the exact results our clients achieve in just 12 weeks
        </p>
                ...
                <div className="aspect-[3/4] relative overflow-hidden">
                  ...
                  <div className="absolute bottom-0 left-0 p-4 w-full">
                    <h3 className="text-2xl font-bold">
                      {activeClient.name}, {activeClient.age}
                    </h3>
              ...
              <div className="p-6 md:p-8 flex flex-col justify-center">
                ...
                <div className="grid grid-cols-2 gap-6 mb-8">
                  <div className="bg-zinc-900 p-4 rounded-lg text-center">
                    ...
                    <div className="flex items-center justify-center gap-3">
                      <p className="text-gray-400 line-through">
                        {activeClient.initialMetrics.weight}lbs
                      </p>
                      <p className="text-xl font-bold">
                        {activeClient.finalMetrics.weight}lbs
                      </p>
                    </div>
                    <p className="text-[#940909] font-bold">
                      -{weightLoss} lbs
                    </p>
                  </div>
                  ...
                  <div className="bg-zinc-900 p-4 rounded-lg text-center">
                    ...
                    <div className="flex items-center justify-center gap-3">
                      <p className="text-gray-400 line-through">
                        {activeClient.initialMetrics.bodyFat}%
                      </p>
                      <p className="text-xl font-bold">
                        {activeClient.finalMetrics.bodyFat}%
                      </p>
                    </div>
                    <p className="text-[#940909] font-bold">
                      -{bodyFatReduction}%
                  ...
                  <div className="bg-zinc-900 p-4 rounded-lg text-center">
                    ...
                    <div className="flex items-center justify-center gap-3">
                      <p className="text-gray-400 line-through">
                        {activeClient.initialMetrics.energy}
                      </p>
                      <p className="text-xl font-bold">
                        {activeClient.finalMetrics.energy}
                      </p>
                    </div>
                  ...
                  <div className="bg-zinc-900 p-4 rounded-lg text-center">
                    ...
                    <div className="flex items-center justify-center gap-3">
                      <p className="text-gray-400 line-through">
                        {activeClient.initialMetrics.stress}
                      </p>
                      <p className="text-xl font-bold">
                        {activeClient.finalMetrics.stress}
                      </p>
                    </div>
