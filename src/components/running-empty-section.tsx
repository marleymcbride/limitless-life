      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="mx-auto max-w-3xl space-y-6 mb-16">
          <p className="text-lg text-white">
            You wake up <span className="text-[#ff6b6b] font-semibold">tired</span>, even after a full night&apos;s sleep. The first thing you reach for is coffee – the first of
          ...
          <p className="text-lg text-white">
            <span className="text-[#ff6b6b] font-semibold">Stress follows you everywhere</span>. Your mind races at night. You snap at your family over small things. You
        ...
        <h2 className="mb-10 text-center text-3xl font-bold text-white">The Three Ways To Live</h2>
        <div className="mx-auto px-2 sm:px-0 max-w-4xl">
          <div className="mb-10 bg-gradient-to-r from-gray-900 to-black rounded-lg p-6 border-l-4 border-gray-500 hover:border-gray-300 transition-all shadow-md">
            <div className="flex items-center mb-4">
              ...
              <h3 className="text-xl sm:text-2xl font-bold text-white">The Typical Lifestyle</h3>
            </div>
            <div className="p-4 bg-black/50 rounded-md">
              ...
              <p className="text-base sm:text-lg text-white">
                <span className="text-red-300 font-medium">You're accessing maybe 20% of your potential</span>, wasting 80% in a fog of low energy and bad habits.
              </p>
            </div>
          </div>
          ...
          <div className="mb-10 bg-gradient-to-r from-blue-900/20 to-zinc-900 rounded-lg p-6 border-l-4 border-blue-500 hover:border-blue-400 transition-all shadow-md">
            <div className="flex items-center mb-4">
              ...
              <h3 className="text-xl sm:text-2xl font-bold text-white">The Health-Conscious</h3>
            </div>
            <div className="p-4 bg-zinc-800/70 rounded-md">
              ...
              <p className="text-base sm:text-lg text-white">
                <span className="text-blue-300 font-medium">You're accessing 50-60% of your potential</span>, but it's a constant struggle.
              </p>
            </div>
          </div>
          ...
          <div className="mb-10 bg-gradient-to-r from-[#940909]/50 to-black/80 backdrop-blur-sm rounded-lg p-6 border-l-4 border-[#940909] hover:scale-[1.02] transition-all shadow-xl">
            ...
            <div className="p-4 bg-black/40 rounded-md">
              ...
              <p className="text-base sm:text-lg text-white">
                <span className="text-[#ff6b6b] font-medium">You're unlocking 95-100% of your potential</span> daily.
              </p>
            </div>
          </div>
