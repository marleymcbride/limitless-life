    ...
    <section className="bg-black py-20 px-6 w-full">
      <div className="container mx-w-max max-w-6xl">
        <div className="text-center">
          <h2 className="text-4xl md:text-5xl font-bold text-white mb-4" style={{ fontFamily: 'Neuemontreal, Arial, sans-serif' }}>
            Why This System Will Work For You
          </h2>
          <h2 className="text-2xl md:text-3xl font-bold text-white mb-8" style={{ fontFamily: 'Neuemontreal, Arial, sans-serif' }}>
