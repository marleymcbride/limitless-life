    ...
    <section className={`w-full ${bgClasses.white} py-20 text-black`}>
      <div className="container mx-auto px-4">
        <div className="text-center mb-10">
          <span className="inline-block bg-[#940909] text-white text-sm font-bold uppercase tracking-wider px-3 py-1 rounded-sm mb-4">Your Coach</span>
          <h2 className="text-3xl sm:text-4xl font-bold mb-4">Meet Your Coach</h2>
          <p className="text-lg text-gray-700 max-w-3xl mx-auto">
            Expert guidance from someone who's been where you are and knows exactly how to get you to where you want to be
          </p>
        </div>
          ...
          <div className="md:w-2/3">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-10">
              <div className="rounded-lg bg-gray-100 p-5 border-l-4 border-[#940909]">
                <p className="font-bold text-lg mb-3">Professional Credentials</p>
              ...
              <div className="rounded-lg bg-gray-100 p-5 border-l-4 border-[#940909]">
                <p className="font-bold text-lg mb-3">Personal Transformation</p>
                <ul className="space-y-2">
                  <li className="flex items-start">
                    <span className="text-[#940909] mr-2">•</span>
