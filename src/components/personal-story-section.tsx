        ...
        <div className="max-w-5xl mx-auto" style={{ maxWidth: "1200px" }}>
          ...
          <div className="prose prose-lg max-w-none mobile-text-large body-copy" style={{ fontSize: "1.3rem" }} data-mobile-style="true">
            <div className="text-center mb-6">
              ...
              >
                <strong>Three Years Ago I Was Blackout Drunk On A Mud-Stained Mattress</strong>
              </h2>
            </div>

            <p className="text-gray-800 leading-relaxed mb-6">
            Do you ever wake up feeling like shit?
            </p>
            ...
            <p className="text-gray-800 leading-relaxed mb-6">
              I had the Masters degree on the wall, hitting the gym every day, earning decent money.
            </p>
            ...
            <p className="text-gray-800 leading-relaxed mb-6">
              Before getting out of bed I was dreading the day.
            </p>

            <p className="text-gray-800 leading-relaxed">
            Dragging myself through work.
            </p>
            ...
            <p className="text-gray-800 font-bold leading-relaxed mb-6">
             <strong> So I doubled down on the quick fixes.</strong>
            </p>
            ...
            <p className="text-gray-800 leading-relaxed mb-6">
              The stress and anxiety was getting too much.
            </p>

            <p className="text-gray-800 leading-relaxed mb-6">
              But I was already doing what the online &apos;gurus&apos; said to do..
            </p>
            ...
            >
            <span className="font-bold">I hit rock bottom.</span>
            </p>

            <p className="text-gray-800 leading-relaxed mb-0">
            So I scrapped everything the &apos;influencers&apos; said and took a different approach..
            </p>
