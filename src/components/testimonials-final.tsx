...
export default function TestimonialPlaceholder({ number, darkBg }: { number: number, darkBg?: boolean }) {
  ...
  const sectionClass = darkBg ? "testimonial-dark-gradient py-16 px-4 w-full mx-6" : "py-16 px-4 w-full bg-gradient-to-br mx-auto from-gray-50 via-white to-gray-50 mx-0";
