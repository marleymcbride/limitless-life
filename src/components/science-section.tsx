  ...
  const sciencePoints = [
    {
      ...
      description:
        "Our proprietary protocol targets the cellular energy systems for maximum fat burning efficiency while preserving lean muscle mass.",
      icon: "/placeholder.svg?height=30&width=30",
    },
    {
      title: "Hormonal Balancing",
      description:
        "We focus on optimizing key hormones like testosterone, cortisol, and insulin that regulate energy, stress, and body composition.",
      icon: "/placeholder.svg?height=30&width=30",
    },
    {
      title: "Stress Recovery Protocol",
      description:
        "Our science-backed approach resets your nervous system's stress response for improved recovery and energy management.",
      icon: "/placeholder.svg?height=30&width=30",
    },
    {
      title: "Sleep Enhancement",
      description:
        "Advanced techniques to optimize sleep architecture for maximum cognitive and physical recovery.",
      icon: "/placeholder.svg?height=30&width=30",
    },
  ];

  return (
    <section className="w-full py-20 px-4 bg-black text-white relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="flex flex-col md:flex-row gap-12 items-center max-w-6xl mx-auto">
          <div className="md:w-1/2">
            <span className="inline-block mb-2 bg-[#940909] py-1 px-3 text-sm rounded-full">
              RESEARCH-BACKED
            </span>
            ...
            <p className="text-gray-300 mb-8">
              Unlike generic fitness programs, our approach is built on
              cutting-edge research in metabolic health, hormonal optimization,
              and executive performance. We combine principles from:
            </p>
            ...
            <div className="bg-zinc-800 rounded-xl p-6 border border-zinc-700">
              ...
              <div className="border-t border-zinc-700 pt-4">
                ...
                <div className="flex flex-wrap gap-2 mb-4">
                  <div className="bg-zinc-900 rounded-full py-1 px-3 text-xs">
                    Functional Medicine
                  </div>
                  <div className="bg-zinc-900 rounded-full py-1 px-3 text-xs">
                    Endocrinology
