                ...
                <div className="flex items-center mb-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      15 months sober • 35lbs fat loss
                    </p>
                  </div>
                </div>
                <blockquote className="text-lg text-gray-800 italic mb-4">
                  "I was drinking heavily after work, looked rough, my
                  high-stakes job was tanking, split with my girlfriend,
                  hormones were shot. Now I'm completely off alcohol and
                  caffeine, down 35lbs, crushing it at work, new girlfriend, and
                  over a year sober. This literally saved my life."
                </blockquote>
          ...
          <div className="space-y-6">
              ...
              <div className="flex items-start">
                ...
                <div>
                  <h3 className="font-bold text-gray-900 mb-2">
                    5:30 AM - Already Behind
                  </h3>
                  <p className="text-gray-700">
                    You wake up groggy despite 7 hours of sleep. First thing you
                    reach for? Coffee. The first of many cups you'll need today
                    just to function. By 6:30 AM, you're on your second coffee
                    while forcing down a protein bar, checking 30-50 emails,
            ...
            <div className="bg-red-50 border-l-4 border-red-400 p-6 rounded-r-lg">
              <div className="flex items-start">
                ...
                <div>
                  <h3 className="font-bold text-gray-900 mb-2">
                    1:00 PM - The Afternoon Crash
                  </h3>
                  <p className="text-gray-700">
                    Post-lunch brain fog hits hard. Your mental processing slows
                    to a crawl. By 3:30 PM, you're micro-sleeping at your desk,
                    reaching for your fourth coffee of the day. You wonder if
                    this is just what success costs.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-red-50 border-l-4 border-red-400 p-6 rounded-r-lg">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-700">
                    Client dinner or you collapse at home. Either way, you pour
                    2-3 drinks just to "wind down." It's the only way you know
                    how to switch off from work mode. By 11:00 PM, you're
                    exhausted but your mind is racing, poor sleep quality
                    guaranteed.
                  </p>
                </div>
              </div>
            ...
            <div className="bg-red-50 border-l-4 border-red-400 p-6 rounded-r-lg">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-700">
                    You've gained 15-30 pounds around your midsection. Your
                    clothes don't fit right. You avoid looking in the mirror
                    after showers. Zero libido. Taking 12-18 supplements
                    ($300-600/month) trying to fix what's broken, but nothing
                    works.
                  </p>
                </div>
              </div>
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-blue-50 border border-blue-300 rounded-lg p-6">
              <div className="flex items-center mb-4">
                ...
                <h3 className="text-xl font-bold text-gray-900">
                  The Health-Conscious (Where You Are Now)
                </h3>
              </div>
              <p className="text-gray-700 mb-2">
          ...
          <div className="text-center mt-12 p-6 bg-gray-50 rounded-lg">
            ...
            <p className="text-lg text-gray-700">
              They know something's wrong, they're trying to fix it, but they're
              missing the{" "}
