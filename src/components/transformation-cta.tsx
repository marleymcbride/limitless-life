    ...
    <section className="bg-white py-20 w-full">
      <div className="w-full max-w-5xl mx-auto px-4">
        ...
        <div className="text-center mb-12">
          <Button
            className="bg-[#940909] hover:bg-[#7d0808] text-white px-10 py-6 text-xl font-bold rounded-md transition-none duration-0 shadow-lg hover:shadow-xl transform hover:scale-105"
            asChild
          >
            <a
              href="#application"
