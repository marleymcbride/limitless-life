...
export default function ComparisonTable() {
  const comparisonItems = [
    ...
    },
    {
      ...
      before:
        "Carrying 15-30+ lbs of excess weight, especially around the midsection",
    ...
    },
    {
      ...
      before:
        "Scattered focus, procrastination, long hours with diminishing returns",
      after:
        "Laser focus, efficient work habits, accomplishing more in less time",
    },
    {
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center mb-10">
          ...
          <h2 className="text-3xl sm:text-4xl font-bold mb-4">
            Before & After: The Limitless Shift
          </h2>
          <p className="text-center text-xl mb-12 max-w-3xl mx-auto">
            It's your choice - stay trapped in energy drains or transform every
            aspect of your life
          </p>
        </div>
        ...
        <div className="mx-auto max-w-5xl overflow-x-auto rounded-lg shadow-xl">
          <table className="w-full border-collapse">
            <thead>
              <tr>
                <th className="p-4 text-left border-b border-white/10 w-1/4 bg-black/30 text-white">
                  Criteria
                </th>
            ...
            <tbody>
              {comparisonItems.map((item, index) => (
                ...
                >
                  ...
                  <td className="p-4 border-b border-white/10 text-gray-300 bg-black/30">
                    {item.before}
                  </td>
                  <td className="p-4 border-b border-white/10 text-white bg-white/5 font-medium">
                    {item.after}
                  </td>
                </tr>
              ))}
        ...
        <div className="text-center mt-12 max-w-3xl mx-auto bg-black/30 p-8 rounded-lg backdrop-blur-sm border border-[#940909]/30">
          <p className="text-xl mb-6">
            <span className="font-bold">95% of men</span> stay stuck in the left
            column their entire lives. The{" "}
            <span className="font-bold">Limitless 1%</span> take action and
            transform every aspect of their existence.
          </p>

          <p className="text-2xl font-bold mb-8">
            The choice is clear. Join the 1% who've discovered the Limitless
            secret.
          </p>
