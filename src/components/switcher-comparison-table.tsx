    ...
    <section className={`${colorStrategy.whiteSections} py-20`}>
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-6xl mx-auto overflow-hidden rounded-lg border-2 border-gray-300">
          {/* Header Row */}
          <div
            className={`${colorStrategy.blackSections} grid grid-cols-5 p-6 border-b-2 border-gray-300`}
          >
            ...
            <div
              className={`${colorStrategy.blackSections} text-center relative`}
            >
              <div className="absolute inset-0 bg-[#940909] opacity-20"></div>
              <h3
                className={`text-lg font-black ${colorStrategy.redCTA} font-serif relative`}
              >
                This System
              </h3>
            </div>
          ...
          {comparisonData.map((item, index) => (
            <div
              ...
              className={`grid grid-cols-5 p-6 border-b border-gray-200 ${
                index % 2 === 0
                  ? colorStrategy.whiteSections
                  : colorStrategy.whiteAccent
              }`}
            >
              <div className="flex items-center">
                <span
                  className={`text-lg font-semibold ${colorStrategy.blackSections} font-serif`}
                >
                  {item.feature}
                </span>
              </div>
              ...
              <div className="flex items-center justify-center">
                <span className="text-lg text-gray-600 font-serif">
                  {item.traditionalGyms}
                </span>
              </div>
              ...
              <div
                className={`flex items-center justify-center ${buyerTypeUtils.neanderthal.resultClasses} font-serif font-bold`}
              >
                {item.ourSystem}
              </div>
            </div>
        ...
        <div
          className={`mt-12 ${colorStrategy.blackSections} rounded-lg p-8 text-center`}
        >
          <h3
          ...
          <p
            className={`text-lg text-white max-w-3xl mx-auto font-serif leading-relaxed`}
          >
            Other approaches treat symptoms. We engineer the complete
            high-performance lifestyle that busy executives need to excel in
            business and dominate in life.
          </p>
