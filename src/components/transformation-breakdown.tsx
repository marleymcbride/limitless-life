    ...
    <section className={`${colorStrategy.whiteSections} py-20`}>
      <div className="container mx-auto px-4">
          ...
          {transformations.map((item, index) => (
            ...
            >
              ...
              <div className={`text-center mb-6`}>
                <h3
                  className={`text-xl font-black ${colorStrategy.blackSections} font-serif mb-2`}
                >
                  {item.category}
                </h3>
                <div
                  className={`inline-block ${colorStrategy.blackSections} px-3 py-1 rounded-full`}
                >
                  <span
              ...
              <div className="space-y-4">
                ...
                >
                  ...
                  <p className={`text-gray-300 font-serif`}>{item.before}</p>
                </div>

                <div className="text-center">
                  <svg
                    className={`w-6 h-6 ${colorStrategy.redCTA} mx-auto`}
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                  >
                ...
                >
                  <div
                    className={`text-sm font-bold text-green-800 uppercase tracking-wider mb-2`}
                  >
                    After:
                  </div>
              ...
              {/* Impact */}
              <div
                className={`mt-4 p-3 ${colorStrategy.blackSections} rounded-lg text-center`}
              >
                <div
                ...
                <div
                  className={`text-base font-bold ${colorStrategy.redCTA} font-serif`}
                >
                  {item.impact}
                </div>
              </div>
        ...
        >
          ...
          >
            While other programs focus only on weight loss, we engineer complete
            life upgrades. You're not just building a better body - you're
            building a better business, better leadership, and a better legacy.
          </p>
