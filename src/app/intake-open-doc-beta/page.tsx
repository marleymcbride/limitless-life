...
export const metadata: Metadata = {
  title: 'Limitless 2026 Beta - Doors Open',
  description: 'Doors are open for the Limitless Life beta program. Secure your spot today.',
};
      ...
      <GammaArticle>
        ...
        <GammaBlockquote>
          <div className="space-y-4">
            <div>
              <strong>Doors are OPEN</strong> for the beta cohort starting {COHORT_CONFIG.DATE}.
            </div>
            <div>
              There will be <strong>only 10 spots available</strong> as i want to give my full attention to each member.
            </div>
            <div>
              Secure your spot today before doors close on {COHORT_CONFIG.DATE}.
            </div>
            <div>
              — Marley
            </div>
