      ...
      <GammaArticle>
        ...
        <GammaBlockquote>
          <div className="space-y-4">
            <div>
              The next cohort officially kicks off {COHORT_CONFIG.DATE}.
            </div>
            <div>
              There will be <strong>limited spots available</strong> to ensure quality attention to each member.
            </div>
            <div>
              Join the waitlist now to secure early access and special pricing.
            </div>
            <div>
            — Marley
            </div>
