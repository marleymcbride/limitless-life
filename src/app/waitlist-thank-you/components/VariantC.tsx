  ...
  return (
    <>
      ...
      <div className="px-4 mx-auto md:px-20">
        ...
        <p className="text-lg text-center mx-4 md:mx-20 lg:mx-20 md:text-lg mb-6 text-gray-300" style={{ fontFamily: 'system-ui, -apple-system, BlinkMacSystemFont, "SF Pro Display", "Segoe UI", sans-serif', lineHeight: '1.728' }}>
        I&apos;ve crossed you off for the next cohort, but I might have something else that better fits. Take a short quiz below and I&apos;ll give you a custom scorecard showing you exactly what&apos;s draining your energy.
        </p>
      ...
      {/* CTA Button Section */}
      <div className="mt-12 px-4 md:px-20 flex justify-center">
        <button
