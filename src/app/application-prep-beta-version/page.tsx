...
export const metadata: Metadata = {
  ...
  description: "Finish your beta application to The Limitless Protocol.",
};
      ...
      <Suspense
        fallback={
          <div className="text-center animate-fade-in">
            ...
            <p className="text-gray-600 font-medium">Preparing your beta application...</p>
            <style>{`
              @keyframes fadeIn {
