          ...
          {hasStartedVideo && (
            <div className="block sm:hidden text-center font-bold mt-3 px-4">
              <div
                ...
                <p className="text-sm text-gray-000 whitespace-nowrap">Turn to the side for fullscreen 📲</p>
              </div>
            </div>
          )}
            ...
            <div className="bg-transparent bg-opacity-10 p-0">
              ...
              <div className="flex items-center justify-center gap-4">
                ...
                <div className="flex flex-col justify-center">
                  <div className="text-lg font-bold mt-4 text-white">Lewis Allan</div>
                  <div className="text-sm mt-0 text-center">
                  <div className="font-normal mt-0 mb-2 text-gray-200">Energy Sector</div>
