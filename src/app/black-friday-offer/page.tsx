...
import { blackFridayVignetteEffect, BLACKFRIDAYunifiedGradientWithSpotlightMobile, BLACKFRIDAYunifiedGradientWithSpotlightDesktop, vignetteEffect } from "@/lib/utils";
...
export default function BlackFridayOffer() {
  return (
    <main className="flex flex-col min-h-screen">
      ...
      <section
        className={`pt-12 md:pt-14 px-3 mt-10 pb-16 px-16min-h-[100vh] sm:pb-16 flex flex-col relative w-full overflow-hidden bg-black`}
      >
        <div className="hidden md:block bg-black">{BLACKFRIDAYunifiedGradientWithSpotlightDesktop}</div>
        <div className="block md:hidden bg-black ">{BLACKFRIDAYunifiedGradientWithSpotlightMobile}</div>
        <div className="hero-grain-overlay "></div>
        <div className="hero-darkening-overlay bg-black"></div>
        {vignetteEffect}
        ...
        <div className="container hero-full-width x-20 max-w-81 flex relative z-30 flex-col mx-auto h-full">
          <div className="flex flex-col flex-grow mx-12 justify-start pt-5 sm:justify-center sm:pt-0 sm:mt-6 md:mt-0">

          <p className="hidden px-1 mx-auto mb-4 text-2xl text-center text-gray-300 sm:block sm:text-xl md:text-lg lg:text-xl max-w-[100px]">
          BLACK FRIDAY OFFER
            </p>
            ...
            <h1 className="sm:block px-0 mx-auto text-5xl sm:text-5xl md:text-4xl lg:text-5xl font-bold text-white text-center mb-0 sm:mt-0 max-w-[87%] capitalize">
            Lose Your Gut, Stop Waking Up Exhausted & Reverse Years Of Health Decline (In Just 2 Days Per Week)
            </h1>

            {/* Subheadline MOB*/}
            <p className="mobile-subheadline block mx-auto mb-0 font-light text-center text-gray-300 sm:hidden px-0 text-[1.3rem] leading-[1.6] max-  w-[40%]">
              Stop feeling exhausted, build an elite body, and get back years of energy
            </p>
                        <p className="mobile-subheadline block mx-auto mb-2 font-light text-center text-gray-300 sm:hidden px-0 text-[1.3rem] leading-[1.6] max-  w-[40%]">
              —while training just 2 days per week.
            </p>

            {/* Subheadline MOB*/}
            <p className="hidden px-1 mx-auto mb-0 text-xl text-center text-gray-300 sm:block sm:text-xl md:text-lg lg:text-xl max-w-[100px]">
              Stop feeling exhausted, build an elite body, and get back years of energy
            </p>
            <p className="hidden px-1 mx-auto mb-4 text-xl text-center text-gray-300 sm:block sm:text-xl md:text-lg lg:text-xl max-w-[100px]">
              (whilst training just 2 days per week).
            </p>
        ...
        <div className="container mx-auto max-w-4xl">
          ...
          <div className="space-y-8">
            <div className="mb-6">
              ...
              <p className="text-gray-800 mb-4">First thing we&apos;ll do is get crystal clear on your gameplan. Every situation, life, and journey to becoming Limitless is different. That&apos;s why we run you through The Lifestyle X-Ray, then craft your Limitless Gameplan of:</p>
              <div className="space-y-2 text-gray-800">
                <p>• Your <strong>2-Day Build System™ Plan</strong>: We craft your elite body in just 2-3 days of training using <strong>Power Presence Method™</strong> to build muscle that creates masculine presence and aura</p>
        ...
        <div className="full-width-content py-16 px-4">
          <div className="container mx-auto max-w-4xl">
            ...
            <div className="text-lg md:text-xl space-y-4 mb-12">
              ...
              <div className="mb-4">
                <p className="text-gray-100 mb-4">
                  ✔ <strong>Your Custom Limitless Gameplan</strong> - Built specifically for your body after <strong>The Lifestyle X-Ray™</strong> identifies exactly where we should put our efforts.
                </p>
              </div>
