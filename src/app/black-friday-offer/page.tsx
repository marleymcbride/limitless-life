...
import { blackFridayVignetteEffect } from "@/lib/utils";

export const metadata: Metadata = {
  title: "Limitless Protocol - Black Friday Founding Cohort",
  description: "Limited time offer for The Limitless Protocol founding cohort. Only 10 spots available.",
};

export default function BlackFridayOffer() {
  return (
    <main className="min-h-screen bg-black text-white relative">
        {/* Simple grain overlay only */}
      ...
      <div className="container pl-9 pr-4 py-8 sm:px-6 max-w-2xl">
        ...
        <div className="text-center mb-8 mt-6">
          <div className="text-4xl md:text-5xl font-bold mb-4">
            LIMITLESS LIFE: BLACK FRIDAY FOUNDING COHORT
          </div>
        </div>
        ...
        <div className="text-base md:text-lg space-y-6 mb-12">
          ...
          <p className="text-2xl md:text-3xl font-bold text-center mb-14 mt-8">
          ...
          <p className="text-2xl md:text-3xl font-bold text-center mb-14">
          ...
          <p className="text-gray-100 underline mb-8">
            Period.
          </p>
          ...
          <div className="text-2xl text-center mb-14 md:text-3xl font-bold my-12">
          ...
          <p className="text-2xl md:text-3xl font-bold text-center mb-14 mb-12">
          ...
          <p>Client L - drinking heavily, looking rough. 15 months later - sober, 35 pounds lighter, crushing his career. Rob dropped 186 to 169. Laurence - 68kg to 62.5kg in 8 weeks, body fat 12-13% down to 9-10%.</p>
          ...
          <div className="space-y-8">
            <div className="mb-6">
              <p className="font-bold">SYSTEM 1: THE LIMITLESS MORNING SYSTEM</p>
              <p className="text-gray-100 mb-2"><strong>Fixes:</strong> Circadian Disruption + Mitochondrial Suppression. We use <strong>The Anti-Stack™</strong> and <strong>Circadian Re-alignment System</strong>.</p>
              <p className="text-gray-100 italic">What this means: Within a few weeks you're waking up clear. You stop dragging yourself to the bathroom wondering how you'll make it through the day.</p>
            </div>

            <div className="mb-6">
              <p className="font-bold">SYSTEM 2: THE LIMITLESS TRAINING SYSTEM</p>
              <p className="text-gray-100 mb-2"><strong>Fixes:</strong> Cortisol Dominance preventing recovery. We use <strong>Rest-Focused Training™</strong> and <strong>Power Presence Method™</strong>.</p>
              <p className="text-gray-100 italic">What this means: You train twice a week. Your body actually changes—shoulders fill out, gut disappears. You stop looking soft and are embarrassed to take your shirt off.</p>
            </div>

            <div className="mb-6">
              <p className="font-bold">SYSTEM 3: THE LIMITLESS LIFESTYLE SYSTEM</p>
              <p className="text-gray-100 mb-2"><strong>Fixes:</strong> Dopamine Dysfunction + Cortisol Dominance. We use <strong>Alcohol-Free Lifestyle System</strong> and <strong>Natural Energy Protocol</strong>.</p>
              <p className="text-gray-100 italic">What this means: You stop needing to drink on Friday just to turn your brain off. Saturday morning you wake up with the whole weekend ahead instead of wasting it recovering.</p>
            </div>

            <div className="mb-6">
              <p className="font-bold">SYSTEM 4: THE LIMITLESS HEALTH SYSTEM</p>
              <p className="text-gray-100 mb-2"><strong>Fixes:</strong> Insulin Resistance + Hormone Imbalance. We use <strong>Metabolic Priming™</strong> and <strong>Hormone Reset™</strong>.</p>
              <p className="text-gray-100 italic">What this means: Your testosterone goes from 450 to 720 naturally. You're thinking faster when decisions matter. Your wife notices. You feel 10-15 years younger.</p>
            </div>
          </div>
          ...
          <div className="space-y-8">
            <div className="mb-6">
              ...
              <p className="text-gray-100">• Start body recomposition</p>
            </div>
          ...
          <div className="text-2xl text-center mb-18 md:text-3xl font-bold my-12">
            What You Get
          </div>

          <div className="space-y-4">
            <div className="mb-4">
              <p className="font-bold">Multiple coaching calls every week:</p>
              <p className="text-gray-100">2-3 calls per week for 4 months. Not once per month. These are working sessions.</p>
            </div>

            <div className="mb-4">
              <p className="font-bold">Direct text access:</p>
              <p className="text-gray-100">WhatsApp during work hours. Text when you're stuck, response same day. Me responding. Not a bot.</p>
            </div>

            <div className="mb-4">
              <p className="font-bold">10 guys starting together:</p>
              <p className="text-gray-100">All starting January 1st. All going through the same weeks. Not thousands of people. 10 guys.</p>
            </div>

            <div className="mb-4">
              <p className="font-bold">The complete system:</p>
              <p className="text-gray-100">Everything delivered week by week through a simple app.</p>
            </div>
          </div>
          ...
          <p className="font-bold mb-4">This ISN'T For You If:</p>
          <p className="text-gray-100">• You're looking for a quick fix or magic pill</p>
          <p className="text-gray-100">• You want to keep drinking and just manage symptoms</p>
          <p className="text-gray-100">• You've worked with coaches before and it was always their fault</p>
          <p className="text-gray-100">• You're not willing to train 2-3x per week consistently</p>
          <p className="text-gray-100">• You're looking for a diet plan or workout routine</p>
          <p className="text-gray-100">• You're not ready to invest in yourself at the highest level</p>

          <p className="font-bold mb-4">This IS For You If:</p>
          <p className="text-gray-100">• You're making at least $150k and you know your Body is the bottleneck</p>
          <p className="text-gray-100">• You're tired of reading the same email three times and nothing Going in</p>
          ...
          <p className="text-gray-100 mb-12">
            If you need a guarantee to take action on your own health, you're not ready for the level of commitment this demands.
          </p>

          {/* Two Paths Section */}
          <div className="text-2xl md:text-3xl font-bold my-12">
            Your options
          </div>

          <p className="font-bold mb-4">Join:</p>
          <p className="text-gray-100">90 days from now you're that guy. The one who walks in and people listen. The one who's sharp when everyone else is fading. You have what you used to watch other people have.</p>
          ...
          <div className="text-center mb-14">
            <p className="text-2xl md:text-3xl font-bold mb-8">10 spots. Doors close December 2nd. Starts January 1st.</p>

          {/* CTA Button */}
          <div className="text-center mt-12">
            <a
              href="/application"
              className="font-bold !text-white transition-none duration-0 focus:outline-none bg-[#940909] hover:bg-[#7b0707] py-3 px-12 text-lg rounded-md inline-block relative z-30 mb-12"
            >
              JOIN NOW
            </a>
          </div>
