...
// BETA PAGE - Darker hero background (off-black, no grey transition)
export const betaUnifiedGradientWithSpotlightDesktop = React.createElement("div", {
  className: "absolute inset-0 z-10",
  style: {
    background: `
      radial-gradient(circle at 99% 4%,
        ...
        rgba(148, 9, 9, 0.00001575) 53%,
        transparent 55%),
      linear-gradient(to bottom, transparent 0%, transparent 25%, rgba(5, 5, 5, 0.3) 28%, rgba(5, 5, 5, 0.6) 29%, rgb(5, 5, 5) 30%, rgb(8, 8, 8) 72%, rgba(148, 9, 9, 0.5) 85%, rgba(148, 9, 9, 0.864) 100%)
    `,
    pointerEvents: "none",
  },
});

// BETA PAGE - Mobile darker background
export const betaUnifiedGradientWithSpotlightMobile = React.createElement("div", {
  className: "absolute inset-0 z-10",
  style: {
    background: `
      radial-gradient(circle at 99% 2%,
        ...
        rgba(148, 9, 9, 0.288) 12%,
        rgba(148, 9, 9, 0.24) 14%,
        rgba(148, 9, 9, 0.216) 16%,
        rgba(148, 9, 9, 0.192) 18%,
        rgba(148, 9, 9, 0.168) 20%,
        rgba(148, 9, 9, 0.144) 22%,
        rgba(148, 9, 9, 0.12) 24%,
        rgba(148, 9, 9, 0.108) 26%,
        rgba(148, 9, 9, 0.096) 28%,
        rgba(148, 9, 9, 0.084) 30%,
        rgba(148, 9, 9, 0.072) 32%,
        rgba(148, 9, 9, 0.06) 34%,
        rgba(148, 9, 9, 0.048) 36%,
        rgba(148, 9, 9, 0.036) 38%,
        rgba(148, 9, 9, 0.024) 40%,
        rgba(148, 9, 9, 0.0192) 42%,
        rgba(148, 9, 9, 0.0144) 44%,
...
// ATF Background - No bottom red (extended black middle section)
export const betaUnifiedGradientWithSpotlightDesktopNoBottomRed = React.createElement("div", {
  className: "absolute inset-0 z-10",
  style: {
    background: `
      radial-gradient(circle at 99% 4%,
        ...
        rgba(148, 9, 9, 0.00001575) 53%,
        transparent 55%),
      linear-gradient(to bottom, transparent 0%, transparent 25%, rgb(0, 0, 0) 35%, rgb(0, 0, 0) 100%)
    `,
    pointerEvents: "none",
  },
});

// ATF Background - Mobile no bottom red (extended black middle section)
export const betaUnifiedGradientWithSpotlightMobileNoBottomRed = React.createElement("div", {
  className: "absolute inset-0 z-10",
  style: {
    background: `
      radial-gradient(circle at 99% 2%,
