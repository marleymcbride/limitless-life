...
const testimonials: Testimonial[] = [
  {
    ...
    content: "Marley is the only coach who actually understands the unique energy challenges high-performers face. His Limitless Protocol didn't just transform my productivity—it completely rewired my relationship with energy.",
  ...
  },
  {
    ...
    handle: "@Sneharathe",
    content: "Best video on the internet. Helped me so much in getting my life back on track, kept a record of my time and helped me get closer to my goals. Thank you so much for helping out!!",
  ...
  },
  {
    ...
    content: "To be honest, I only watch your videos at the moment, because you make such amazing content that inspires me to take out my journal. So Olly, thank you again for an amazing video.",
  ...
  },
  {
    ...
    username: "Sam",
    handle: "@Sam-qk4pj",
    content: "Love how doable this is, most journaling prompts and system overwhelm me.",
  ...
  },
  {
    ...
    content: "Hi Olly! I like your simple approach to productivity. In fact, I've already gone out and purchased a pocket notebook to carry around with me - love, love, LOVE this idea!",
    color: "#4C51BF",
    avatar: ""
  },
  {
    ...
    content: "So underrated! The level of research and information compiled into one video is great for someone like me who's watched so many journaling and self improvement videos but struggles to implement the advice.",
    color: "#E53E3E",
    avatar: ""
  },
  {
    ...
    content: "Your vibe, way of explaining your ability to segue into other topics and conciseness is like... AMAZING!",
    color: "#DD6B20",
