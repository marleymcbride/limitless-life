...
- Build admin dashboards as expansive, full-page, notion-style layouts with large 2x2 grid sections that fill the page, not compact metric boxes. Confidence: 0.70
